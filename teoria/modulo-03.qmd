...
Una forma habitual de evaluar el comportamiento de una cartera frente a sus comparables es **situarla dentro de un ranking**, usando medidas como **cuartiles** y **percentiles**. Estas métricas permiten presentar los resultados de forma comprensible y relativa para el cliente.

Se aplican tanto a:

- **Rentabilidades simples** (a 1, 3, 5 años...)
- Como a medidas de riesgo: **volatilidad**, **beta** o **coeficiente $R^2$**

#### ¿Qué indican estas medidas?

| Medida         | Significado                                                |
|----------------|------------------------------------------------------------|
| Cuartil 1 (Q1) | El fondo está entre el 25 % con mejores resultados         |
| Cuartil 4 (Q4) | El fondo está entre el 25 % con peores resultados          |
| Percentil 10   | El fondo supera al 90 % de su universo comparable          |

Estas clasificaciones son especialmente útiles para evaluar la **consistencia del rendimiento** en el tiempo.

#### Representación gráfica

![](images/clipboard-800546292.png)

::: {.callout-note}
**Interpretación:**
- El fondo se sitúa en el **cuartil 1 y percentil 15** → rendimiento superior al 85 % de sus comparables.
- Esto puede reforzar la percepción de **gestión eficaz y competitiva**, especialmente si se mantiene en el tiempo y en varias métricas (Sharpe, alfa, etc.).
:::
...
Las **GIPS (Global Investment Performance Standards)** son un conjunto de normas internacionales desarrolladas por el **CFA Institute**. Su objetivo es garantizar que la **presentación del rendimiento histórico de carteras gestionadas** sea:
...
#### ¿Qué entidades aplican GIPS?

- Gestoras de fondos de inversión
- Sociedades de gestión discrecional de carteras
- Firmas de banca privada
- Cualquier entidad que quiera presentar resultados consolidados a clientes o terceros

---

### Contenidos esenciales GIPS

| Concepto                         | Requisito según GIPS                                               |
|----------------------------------|---------------------------------------------------------------------|
| **Primera publicación**          | Debe incluir al menos **5 años de datos** completos (o desde inicio si <5 años) |
| **Ampliación posterior**         | Se deben ir añadiendo **1 año más por ejercicio** hasta alcanzar **10 años mínimos** |
| **Universo de carteras**         | Deben incluirse **todas las carteras gestionadas con objetivos similares** |
| **Criterios de inclusión**       | Por **estrategia de inversión**, no por resultados                  |
| **Benchmark de referencia**      | Obligatorio. Debe ser **adecuado, objetivo y coherente** con la política de inversión |
| **Comisiones y gastos**          | La rentabilidad debe reflejar **todos los costes reales incurridos** (neto de comisiones) |
| **Moneda y horizonte temporal**  | Todas las carteras deben presentarse en **la misma moneda y periodo** |
| **Frecuencia mínima de informe** | Al menos **anual**                                                  |
| **Verificación externa**         | **Opcional**, pero altamente recomendable para aportar credibilidad |

---
::: {.callout-note}
 
Aunque las normas GIPS son de **adhesión voluntaria**, una entidad que se declare conforme debe aplicarlas **íntegramente y sin excepciones** a todas las carteras gestionadas bajo la misma estrategia.  
La verificación externa no es obligatoria, pero **refuerza la transparencia y credibilidad ante clientes institucionales**.
:::

::: {.callout-tip}
## **Pregunta típica de examen:**  
Una firma que comienza a reportar conforme a las normas GIPS debe presentar **al menos 5 años de historial de rendimiento** (o todos los disponibles si tiene menos antigüedad).  
Posteriormente, debe **añadir un año adicional por ejercicio** hasta completar **10 años como mínimo**.
:::
